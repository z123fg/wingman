            ...
            try {
                ...
                const micStream = await navigator.mediaDevices.getUserMedia({
                    audio: {
                        ...
                        // @ts-expect-error — voiceIsolation is a newer Chrome constraint not yet in TS types
                        voiceIsolation: true,
                    },
                    video: false,
                });
                ...
                if (source === "mic+system") {
                    try {
                        ...
                        console.warn(
                            "[audio] system audio unavailable, mic only:",
                            e,
                        );
                    }
                }
                ...
                // Connect mic through a gain node to boost volume
